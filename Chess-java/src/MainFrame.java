...
public class MainFrame implements ActionListener{
	...
	public void insertImage(JButton button,Piece piece) {
		...
		Icon rook1 = new ImageIcon("wR.png"); 
		Icon knight1 = new ImageIcon("wN.png"); 
		Icon bishop1 = new ImageIcon("wB.png"); 
		Icon queen1 = new ImageIcon("wQ.png"); 
		Icon king1 = new ImageIcon("wK.png"); 
		Icon pawn1 = new ImageIcon("wP.png"); 
		
		Icon rook2 = new ImageIcon("bR.png"); 
		Icon knight2 = new ImageIcon("bN.png"); 
		Icon bishop2 = new ImageIcon("bB.png"); 
		Icon queen2 = new ImageIcon("bQ.png"); 
		Icon king2 = new ImageIcon("bK.png"); 
		Icon pawn2 = new ImageIcon("bP.png");
